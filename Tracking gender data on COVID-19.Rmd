...
Table 1 summarizes the sex-disaggregated data available as of `r day` `r months(as.Date(str_c("2021-", month, "-", day)))` 2021. There were 55 countries reporting sex-disaggregated data for COVID-19 cases and deaths. (These include three nations of the United Kingdom – England, Scotland, and Northern Ireland – that are reported separately. Wales reports cases only.) They represent 48 percent of the world’s population (2019 data). 8 countries report sex-disaggregated data for deaths only. Forty-three more countries report sex-disaggregated data on cases but lack data on deaths. In total, four out of five people now live in a country with at least some sex-disaggregated data on COVID-19. For countries reporting sex-disaggregated data on both cases and deaths, women make up 49 percent of cases but only 42 percent of deaths.

Figure out formatting of numbers in table and rename variable names
